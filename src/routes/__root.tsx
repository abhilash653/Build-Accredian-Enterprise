  ...
  head: () => ({
    meta: [
      ...
      { title: "Accredian Enterprise" },
      {
        name: "description",
        content:
          "Enterprise upskilling programs in AI, Data Science, Product and Leadership, built with IITs, IIMs and global universities.",
      },
      { name: "author", content: "Accredian Enterprise" },
